...
class ParametrosControllerTest < ActionController::TestCase
  ...
  test "should create parametro" do
    assert_difference('Parametro.count') do
      post :create, parametro: { logo_empresa: @parametro.logo_empresa, nombre_empresa: @parametro.nombre_empresa }
    end
  ...
  test "should update parametro" do
    patch :update, id: @parametro, parametro: { logo_empresa: @parametro.logo_empresa, nombre_empresa: @parametro.nombre_empresa }
    assert_redirected_to parametro_path(assigns(:parametro))
  end
